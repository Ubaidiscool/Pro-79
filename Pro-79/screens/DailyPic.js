...
export default class DailyPicScreen extends Component {
    ...
    getAPOD = () => {
        axios
            .get("https://api.nasa.gov/planetary/apod?api_key=Os8z5SY4UMnjfkVj111ynY2X4hvqJPY1jsvYl4ZH")
            .then(response => {
        ...
        if (Object.keys(this.state.apod).length === 0) {
            ...
            return (
                <View style={styles.container}>
                    ...
                    <ImageBackground source={require('../assets/b.gif')} style={styles.backgroundImage}>
